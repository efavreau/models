...
let objName = "5751_byObj";
    ...
    var urlvalue = urlprefix + objName + "/" + objName + ".glb";
    ...
    function setupInstanceMeshGltf() {
        ...
        loader.load(urlGltf, function(gltf) {
            ...
            for (var i = 0; i < gltf.animations.length; i++) {
                testanim.push(gltf.animations[i]);
            }
    ...
    function setupDragControl() {
        ...
        modifyFld
            ...
            .name("ScaleX")
            .listen()
            .onChange(modifyScaleX);
        modifyFld
            .add(settings, "ScaleY")
            .name("ScaleY")
            .listen()
            .onChange(modifyScaleY);
        modifyFld
            .add(settings, "ScaleZ")
            .name("ScaleZ")
            .listen()
            .onChange(modifyScaleZ);
        modifyFld
            .add(settings, "Handle")
            .name("ShowHandle")
            .listen()
            ...
            exporter.parse(
                ...
                function(result) {
                    if (result instanceof ArrayBuffer) {
                        saveArrayBuffer(result, s2 + ".glb");
                    } else {
                        const output = JSON.stringify(result, null, 2);
                        //console.log(output);
                        saveString(output, s2 + ".gltf");
                    }
                },
                options
            );
    ...
    function modifyScaleX(value) {
        ScaleX = value;
    }

    function modifyScaleY(value) {
        ScaleY = value;
    }

    function modifyScaleZ(value) {
        ScaleZ = value;
    }
    ...
    function modifyPosEnd() {
        if (model.uuid === firstobjuuid) {
            posXmem = model.position.x;
            posYmem = model.position.y;
            posZmem = model.position.z;
    ...
    function setupMesh() {
        ...
        let url =
            ...
            //Floor
            //"https://raw.githubusercontent.com/efavreau/models/main/4821_floor/4821_floor.obj";
            //"https://raw.githubusercontent.com/efavreau/models/main/4354_DarkConcrete/4354_DarkConcrete.obj";
            ...
            new OBJLoader(manager)
                ...
                .load(
                    ...
                    function(object) {
                        ...
                        //objs.push(object);//no
                        HashtableObjMat(object); //Hashtable Object Name / Material
                        buffobjects.push(object); //export
                        firstobjuuid = object.uuid;
                    },
                    onProgress,
                    onError
                );
